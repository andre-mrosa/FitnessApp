...
{
    /// <inheritdoc />
    public partial class AddAthletesTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalTrainerNotes = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                    AthleteNotes = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ExerciseId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TrainingPlanId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Repetitions = table.Column<int>(type: "INTEGER", nullable: false),
                    PersonalTrainerNotes = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    AthleteNotes = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
